document.addEventListener("DOMContentLoaded", () => {
    ...
    function toggleInlineReply(parentDiv, commentIndex, rIndex) {
        ...
        replyBox.querySelector(".reply-submit").addEventListener("click", () => {
            ...
            let replyTo;
            if (rIndex !== null) {
                replyTo = comments[commentIndex].replies[rIndex].username ?? "Anonymous";
            } else {
                replyTo = comments[commentIndex].username ?? "Anonymous";
            }
